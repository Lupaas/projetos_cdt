...
# Global para segurar a referência da imagem do logo e não sumir da tela
logo_cardapio = None
...
def mostrar_cardapio():
    ...
    # Tenta carregar a imagem do logo com segurança
    try:
    ...
    # Corrigido a estrutura da lista de produtos (sempre mantendo Tuplas com Nome e Preço)
    produtos = [
        ("Açaí Tradicional 300ml", "R$ 15,00"),
        ("Açaí Tigelão da Casa 500ml", "R$ 22,00")
    ]
    ...
    for nome, preco in produtos:
        ...
        produto.pack(fill="x", padx=50, pady=7)

        nome_label = tk.Label(
            produto, text=nome, font=("Arial", 13, "bold"), fg=BRANCO, bg="#261044"
        )
        nome_label.pack(side="left", padx=20, pady=15)

        preco_label = tk.Label(
            produto, text=preco, font=("Arial", 12, "bold"), fg=AMARELO, bg="#261044"
        )
        preco_label.pack(side="right", padx=20)
...
def adicionar_produto(produto):
    ...
    messagebox.showinfo("Açaízon", f"{produto} foi adicionado ao pedido!")
...
def mostrar_cliente():
    ...
    formulario.pack(padx=60, pady=10, fill="x")

    tk.Label(
        formulario, text="Nome do cliente", font=("Arial", 11, "bold"), fg=BRANCO, bg="#21103D"
    ).pack(anchor="w", padx=25, pady=(25, 5))

    entrada_nome = tk.Entry(
        formulario, font=("Arial", 12), bg="#32194F", fg=BRANCO, insertbackground=BRANCO, relief="flat"
    )
    entrada_nome.pack(fill="x", padx=25, ipady=8)

    tk.Label(
        formulario, text="Telefone", font=("Arial", 11, "bold"), fg=BRANCO, bg="#21103D"
...
def mostrar_delirio_roxo():
    ...
    tk.Label(
        caixa, text="Olá, cliente! 💜", font=("Arial", 22, "bold"), fg=BRANCO, bg="#21103D"
    ).pack(pady=(50, 10))
    ...
    pontos = tk.Frame(
        caixa, bg="#32134F", highlightbackground=ROXO_MEDIO, highlightthickness=1
    )
    pontos.pack(padx=60, pady=30, fill="x")

    tk.Label(
        pontos, text="💜 Seus pontos", font=("Arial", 12, "bold"), fg=AMARELO, bg="#32134F"
    ).pack(pady=(18, 5))

    tk.Label(
        pontos, text="120 pontos", font=("Arial", 28, "bold"), fg=BRANCO, bg="#32134F"
    ).pack()
    ...
    tk.Label(
        caixa, text="🎁 Próximo benefício", font=("Arial", 11, "bold"), fg=VERDE, bg="#21103D"
    ).pack(pady=(5, 8))

    tk.Label(
        caixa, text="Açaí tradicional grátis", font=("Arial", 13, "bold"), fg=BRANCO, bg="#21103D"
    ).pack()

    tk.Label(
        caixa, text="Ao alcançar 150 pontos", font=("Arial", 9), fg=CINZA, bg="#21103D"
    ).pack(pady=5)
...
titulo_cadastro = tk.Label(
    painel_direito, text="👤   Cadastro + Informações", font=("Arial", 11, "bold"), fg=BRANCO, bg="#21103D"
)
titulo_cadastro.pack(pady=(20, 10))

icone_cliente = tk.Label(painel_direito, text="●", font=("Arial", 35), fg=ROSA, bg="#21103D")
icone_cliente.pack()
...
titulo_pedidos = tk.Label(
    painel_direito, text="♻   Últimos pedidos", font=("Arial", 10, "bold"), fg=VERDE, bg="#21103D"
)
titulo_pedidos.pack(anchor="w", padx=20, pady=(15, 8))

pedidos = tk.Frame(painel_direito, bg="#261044", highlightbackground=ROXO_MEDIO, highlightthickness=1)
pedidos.pack(fill="x", padx=18)

tk.Label(pedidos, text="🥣", font=("Arial", 25), fg=BRANCO, bg="#261044").pack(pady=(12, 3))
tk.Label(pedidos, text="Nenhum pedido encontrado", font=("Arial", 9, "bold"), fg=BRANCO, bg="#261044").pack()
tk.Label(
    pedidos,
...
titulo_info = tk.Label(
    painel_direito, text="●   Informações do cliente", font=("Arial", 10, "bold"), fg=AMARELO, bg="#21103D"
)
